...
const getExampleObject = ({ fieldMap = {}, typeName, typeConflictReporter, }) => Object.keys(fieldMap).reduce((acc, key) => {
...
const buildExampleValue = ({ descriptor, typeConflictReporter, isArrayItem = false, path = ``, }) => {
...
const prepareConflictExamples = (descriptor, isArrayItem) => {
    ...
    if (isArrayItem) {
        ...
        const groups = (0, lodash_groupby_1.default)(conflictingTypes, (type) => descriptor[type]?.first || ``);
