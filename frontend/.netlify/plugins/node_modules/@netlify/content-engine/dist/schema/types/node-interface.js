...
exports.NodeInterfaceFields = [`id`, `parent`, `children`, `internal`];
    ...
    const nodeInterfaceTC = schemaComposer.getOrCreateIFTC(`Node`, (tc) => {
        ...
        tc.addFields({
            ...
            children: {
                ...
                resolve: (source, _args, context) => {
                    const { path } = context;
                    return context.nodeModel.getNodesByIds({ ids: source.children }, { path });
                },
                extensions: {
                    searchable: filter_1.SEARCHABLE_ENUM.SEARCHABLE,
                    sortable: sort_1.SORTABLE_ENUM.SORTABLE,
...
const addNodeInterface = ({ schemaComposer, typeComposer, }) => {
    ...
    (0, exports.addNodeInterfaceFields)({ schemaComposer, typeComposer });
};
exports.addNodeInterface = addNodeInterface;
const getNodeInterface = ({ schemaComposer, }) => getOrCreateNodeInterface(schemaComposer);
