...
const errors = {
    "": {
        text: (context) => {
            const sourceMessage = context && context.sourceMessage
    ...
    "95312": {
        ...
        category: types_1.ErrorCategory.USER,
        type: types_1.Type.HTML_COMPILATION,
    },
    "95313": {
    ...
    "95315": {
        ...
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.USER,
        type: types_1.Type.ENGINE_EXECUTION,
    },
    "98001": {
        ...
        type: types_1.Type.ENGINE_VALIDATION,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.UNKNOWN,
    },
    "98011": {
        ...
        type: types_1.Type.ENGINE_COMPILATION,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.USER,
    },
    "98123": {
    ...
    "85901": {
        text: (context) => (0, common_tags_1.stripIndent)(`
        There was an error in your GraphQL query:\n\n${context.sourceMessage}${optionalGraphQLInfo(context)}`),
        type: types_1.Type.GRAPHQL_UNKNOWN,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.USER,
    },
    "85908": {
        ...
        type: types_1.Type.GRAPHQL_VALIDATION,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.USER,
    },
    "85910": {
        text: (context) => (0, common_tags_1.stripIndents)(`
    ...
    "85911": {
      ...
      `),
        type: types_1.Type.GRAPHQL_EXTRACTION,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.USER,
    },
    "85912": {
    ...
    "85920": {
        text: (context) => {
            const staticQueryMessage = (0, common_tags_1.stripIndents)(`Suggestion 1:
      ...
      If you're not using a page query but useStaticQuery you see this error because it doesn't support variables. To learn more about the limitations: https://gatsby.dev/use-static-query`);
            const generalMessage = (0, common_tags_1.stripIndents)(`Suggestion 2:
    ...
    "85928": {
        ...
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.UNKNOWN,
        type: types_1.Type.GRAPHQL_QUERY_RUNNING,
    },
    "85929": {
    ...
    "10122": {
        ...
        type: types_1.Type.API_CONFIG_VALIDATION,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.USER,
    },
    "10123": {
        ...
        type: types_1.Type.API_CONFIG_LOADING,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.USER,
    },
    "10124": {
    ...
    "10127": {
        ...
        type: types_1.Type.API_TYPESCRIPT_COMPILATION,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.USER,
    },
    "10128": {
    ...
    // Plugin errors
    "11321": {
        text: (context) => `"${context.pluginName}" threw an error while running the ${context.api} lifecycle:\n\n${context.sourceMessage ?? context.message}${optionalGraphQLInfo(context)}`,
        type: types_1.Type.API_NODE_EXECUTION,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.UNKNOWN,
    },
    "11322": {
        ...
        level: types_1.Level.ERROR,
        type: types_1.Type.API_NODE_VALIDATION,
        category: types_1.ErrorCategory.USER,
    ...
    "11331": {
        ...
        `),
            ...
            .concat([``])
            .concat(context.validationErrors
    ...
    "11332": {
        ...
        type: types_1.Type.FUNCTIONS_COMPILATION,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.USER,
    ...
    "11521": {
        ...
        category: types_1.ErrorCategory.USER,
        type: types_1.Type.CLI_VALIDATION,
    },
    "11522": {
        text: () => `Failed to generate dev SSL certificate`,
        level: types_1.Level.ERROR,
        category: types_1.ErrorCategory.THIRD_PARTY,
    ...
    "11614": {
        ...
        level: types_1.Level.WARNING,
        category: types_1.ErrorCategory.USER,
        type: types_1.Type.HTML_GENERATION_DEV_SSR,
    },
    "11615": {
        text: (context) => (0, common_tags_1.stripIndent)(`
    ...
    "11801": {
        text: ({ inputManifest }) => `${getSharedNodeManifestWarning(inputManifest)} but Gatsby couldn't find a page for this node.
    ...
    "11804": {
        text: ({ pluginName, nodeId }) => `Plugin ${pluginName} called unstable_createNodeManifest for a node which doesn't exist with an id of ${nodeId}`,
        level: types_1.Level.WARNING,
        category: types_1.ErrorCategory.USER,
        type: types_1.Type.API_NODE_VALIDATION,
    },
    ...
    ${context.sourceMessage}`,
        level: types_1.Level.ERROR,
        type: types_1.Type.API_TYPESCRIPT_TYPEGEN,
        category: types_1.ErrorCategory.USER,
        docsUrl: `https://gatsby.dev/graphql-typegen`,
    },
    // Partial hydration
    "80000": {
        text: (context) => (0, common_tags_1.stripIndents)(`Building partial HTML failed${context?.path ? ` for path "${context.path}"` : ``}
    ...
    `),
        level: types_1.Level.ERROR,
        type: types_1.Type.RSC_COMPILATION,
...
exports.defaultError = exports.errorMap[``];
